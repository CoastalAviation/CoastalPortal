    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                '20171115 - pab - fix carriers changing midstream - change _carrierid to Session("carrierid")
                If InStr(Session("email").ToString.ToLower, "tmcjets.com") > 0 And Session("carrierid") = 0 Then
                    Session("carrierid") = 65
                End If

                '20111121 - pab - convert to single db
                If IsNothing(Session("carrierid")) Or Session("carrierid") = 0 Then
                    '20160517 - pab - fix carrierid = 0 preventing quotes
        ...
        Catch ex As Exception
            ...
            If s <> "Thread was being aborted." Then
                ...
                AirTaxi.Insertsys_log(Session("carrierid"), appName, s, "Page_Load", "AOGRecovery.aspx.vb")
                AirTaxi.InsertEmailQueue(Session("carrierid"), "CharterSales@coastalavtech.com", "pbaumgart@coastalaviationsoftware.com", "", "",
    ...
    Private Sub AOGRecovery_PreRender(sender As Object, e As EventArgs) Handles Me.PreRender
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                '20171115 - pab - fix carriers changing midstream - change _carrierid to Session("carrierid")
                Dim slogotext As String = da.GetSetting(Session("carrierid"), "CompanyLogoText")
                ...
                Me.imglogo.Src = GetImageURLByATSSID(Session("carrierid"), 0, "logo")

                '20171017 - pab - demoair branding
                If Session("carrierid") = 48 Then
                    imglogo.Width = 56
        ...
        Catch ex As Exception
            ...
            End If
            AirTaxi.Insertsys_log(Session("carrierid"), appName, Left(Now & " " & s, 500), "AOGRecovery.aspx.vb Page_PreRender", "")
            SendEmail(Session("emailfrom"), "pbaumgart@coastalaviationsoftware.com", "",
                      appName & " AOGRecovery.aspx.vb Page_PreRender error", s, Session("carrierid"))

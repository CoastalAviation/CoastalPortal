<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ModelDetailPanel.ascx.vb" Inherits="CoastalPortal.ModelDetailPanel" %>
    ...
    <div style="background-color: #669999; width: auto; font-family: Arial, Helvetica, sans-serif; font-size: 7px;">
        <div style="visibility: hidden" runat="server" id="TopStats">
            <table style="width: 100%; font-family: Arial, Helvetica, sans-serif; font-size: 8px; font-weight: bold; color: #FFFFFF;">
                ...
                <tr>
                    <td></td>
                    <td style="float: left">CAS</td>
                    <td>
                        <asp:Label ID="lblmodelid" runat="server" Text="Label"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>Revenue Leg Expense</td>
                    <td>
                        <asp:Label ID="lblrevenueexpense" runat="server" Text=""></asp:Label>
                    </td>


                    <td>Non Revenue Leg Expense</td>
                    <td>
                        <asp:Label ID="lblnonrevenueexpense" runat="server" Text=""></asp:Label>
                    </td>

                    <td>Average Empty Leg NM</td>
                    <td>
                        <asp:Label ID="lblAverageEmtpyNM" runat="server" Text=""></asp:Label>
                    </td>

                    <td>Total Expense</td>
                    <td>
                        <asp:Label ID="lbltotalrevenueexpense" runat="server" Text=""></asp:Label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>Revenue Legs</td>
                    <td style="float: left">
                        <asp:Label ID="lblrevenuelegs" runat="server" Text=""></asp:Label>
                    </td>

                    <td>Non Revenue Legs</td>
                    <td style="float: left">
                        <asp:Label ID="lblnonrevenuelegs" runat="server" Text=""></asp:Label>
                    </td>

                    <td>Shortest Empty Leg NM</td>
                    <td style="float: left">
                        <asp:Label ID="lblShortestEmtpyLeg" runat="server" Text=""></asp:Label>
                    </td>

                    <td>Line Breaks</td>
                    <td>
                        <asp:Label ID="lblLineBreaks" runat="server" Text=""></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>Revenue Miles</td>
                    <td style="float: left">
                        <asp:Label ID="lblrevenuemiles" runat="server" Text=""></asp:Label>
                    </td>
                    <td>Non Revenue Miles</td>
                    <td style="float: left">
                        <asp:Label ID="lblnonrevenuemiles" runat="server" Text=""></asp:Label>
                    </td>
                    <td>Longest EmptyLeg NM</td>
                    <td style="float: left">
                        <asp:Label ID="lblLongestEmptyLeg" runat="server" Text=""></asp:Label>
                    </td>
                    <td>Efficiency</td>
                    <td style="float: left">
                        <asp:Label ID="lblefficiency" runat="server" Text=""></asp:Label>
                    </td>
                </tr>
            </table>
            ...
            <table>
                <tr style="font-size: 9px; color: #FFFFFF;">
                    <td align="right">N Numbers<asp:DropDownList ID="DropDownNNumbers" runat="server" AutoPostBack="True">
                    </asp:DropDownList>
                    </td>
                    <td align="right">Trip Numbers<asp:DropDownList ID="DropDownTripNumbers" runat="server" AutoPostBack="True">
                    </asp:DropDownList>
                    </td>
                    <td align="right">Origin Airports<asp:DropDownList ID="DropDownOriginAirports" runat="server" AutoPostBack="True">
                    </asp:DropDownList>
                    </td>
                    ...
                    <td align="right">Fleet Type<asp:DropDownList ID="DropDownFleetType" runat="server" AutoPostBack="True">
                    </asp:DropDownList>
                    </td>
                    <td align="right">
        ...
        <div>
                    <asp:ListView ID="lvflightlist" runat="server" ItemType="Optimizer.PanelDisplay"   SelectMethod="GetTrips" >
                        <LayoutTemplate>
                        ...
                        <ItemTemplate>
                            <table width="100%">
                                <tr><td>
                                    <h4 style="padding-left: 10px; color: #00ff00">BaseCode: <%#item.Basecode%> </h4>
                                     <h4 style="padding-left: 10px; color: #00ff00">WeightClass: <%#item.WeightClass %> </h4>
                                    <h4 style="padding-left: 10px; color: #00ff00">Aircraft Type: <%#Item.AircraftType %> </h4>

                                    </td>
                                    </tr>
                                <tr>
                                    <td>
                                        <asp:GridView ID="GridViewTrips" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3"
                                            Font-Names="Arial" Font-Size="X-Small" Width="933px" Style="margin-top: 0px" DataSource="<%#Item.PanelRecord %>" ItemType="Optimizer.PanelRecord">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Cost">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkRateDetail" Text='<%#Eval("Cost")%>' DataFormatString="{0:C0}" OnClientClick='<%#Eval("id", "return ShowDetail({0});")%>' runat="server"> </asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="FT">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkEmptyClientSide" Text='<%#Eval("FT")%>' OnClientClick='<%#Eval("id", "return ShowEmpty({0});")%>' runat="server"> </asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="TripNumber" HeaderText="Trip#" SortExpression="TripNumber" />
                                                <asp:TemplateField HeaderText="Ind">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkPTSindividual" Text='<%#Eval("PriorTail")%>' OnClientClick='<%#Eval("id", "return ShowDepart({0});")%>' runat="server"> </asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Grp">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkDepartmentClientSide" Text='<%#Eval("PriorTail")%>' runat="server" PostBackUrl='<%#String.Format("flightchangesNew.aspx?Key={0}", DataBinder.Eval(Container, "DataItem.ID"))%>' OnClientClick="form1.target='_blank'">
                                                        </asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="LRC" HeaderText="LRC" SortExpression="LRC" />
                                                ...
                                                <asp:TemplateField HeaderText="PIC">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkPICClientSide" Text='<%#Eval("PIC")%>' OnClientClick='<%#Eval("id", "return ShowHotel({0});")%>' runat="server">                            
                                                        </asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="SIC" HeaderText="SIC" SortExpression="SIC" />

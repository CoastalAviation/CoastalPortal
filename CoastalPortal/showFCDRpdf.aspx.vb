...
Public Class showFCDRpdf
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Catch ex As Exception
            ...
            If s <> "Thread was being aborted." Then
                ...
                AirTaxi.Insertsys_log(carrierid, appName, s, "Page_Load", "ModelRunHistory.aspx.vb")
    ...
    Private Sub RunOptimizer_PreRender(sender As Object, e As EventArgs) Handles Me.PreRender
        ...
        Catch ex As Exception
            ...
            End If
            AirTaxi.Insertsys_log(carrierid, appName, Left(Now & " " & s, 500), "ModelRunHistory.aspx.vb Page_PreRender", "")
            SendEmail(Session("emailfrom"), "pbaumgart@coastalaviationsoftware.com", "",
                      appName & " ModelRunHistory.aspx.vb Page_PreRender error", s, carrierid)

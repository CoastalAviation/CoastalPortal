<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Error_Page.aspx.vb" Inherits="CoastalPortal.Error_Page" %>
...
<section class="article nopadding">
	...
	<div class="form__order2"  id="form_1" runat="server" >
		...
		<div class="form__buttons">
            <asp:Label ID="lblMsg" runat="server" ForeColor="Red" Text="Error Occurred. Please contact Coastal Aviation Technologies."></asp:Label>
		</div>

...
'
Namespace AviationWebService1_10
    ...
    Partial Public Class WebService1
        ...
        Private InsertEmailQOperationCompleted As System.Threading.SendOrPostCallback
        ...
        '''<remarks/>
        Public Event InsertEmailQCompleted As InsertEmailQCompletedEventHandler
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/InsertEmailQ", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function InsertEmailQ(ByVal userid As String, ByVal userpw As String, ByVal CarrierID As Integer, ByVal recipient As String, ByVal emailcc As String, ByVal bcc As String, ByVal sender As String, ByVal subject As String, ByVal body As String, ByVal isBodyHtml As Boolean, ByVal aircraftlogo As String, ByVal companylogo As String, ByVal showcarrier As Boolean, ByVal attachment As String) As String
            Dim results() As Object = Me.Invoke("InsertEmailQ", New Object() {userid, userpw, CarrierID, recipient, emailcc, bcc, sender, subject, body, isBodyHtml, aircraftlogo, companylogo, showcarrier, attachment})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub InsertEmailQAsync(ByVal userid As String, ByVal userpw As String, ByVal CarrierID As Integer, ByVal recipient As String, ByVal emailcc As String, ByVal bcc As String, ByVal sender As String, ByVal subject As String, ByVal body As String, ByVal isBodyHtml As Boolean, ByVal aircraftlogo As String, ByVal companylogo As String, ByVal showcarrier As Boolean, ByVal attachment As String)
            Me.InsertEmailQAsync(userid, userpw, CarrierID, recipient, emailcc, bcc, sender, subject, body, isBodyHtml, aircraftlogo, companylogo, showcarrier, attachment, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub InsertEmailQAsync(ByVal userid As String, ByVal userpw As String, ByVal CarrierID As Integer, ByVal recipient As String, ByVal emailcc As String, ByVal bcc As String, ByVal sender As String, ByVal subject As String, ByVal body As String, ByVal isBodyHtml As Boolean, ByVal aircraftlogo As String, ByVal companylogo As String, ByVal showcarrier As Boolean, ByVal attachment As String, ByVal userState As Object)
            If (Me.InsertEmailQOperationCompleted Is Nothing) Then
                Me.InsertEmailQOperationCompleted = AddressOf Me.OnInsertEmailQOperationCompleted
            End If
            Me.InvokeAsync("InsertEmailQ", New Object() {userid, userpw, CarrierID, recipient, emailcc, bcc, sender, subject, body, isBodyHtml, aircraftlogo, companylogo, showcarrier, attachment}, Me.InsertEmailQOperationCompleted, userState)
        End Sub
        
        Private Sub OnInsertEmailQOperationCompleted(ByVal arg As Object)
            If (Not (Me.InsertEmailQCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent InsertEmailQCompleted(Me, New InsertEmailQCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1087.0")>  _
    Public Delegate Sub InsertEmailQCompletedEventHandler(ByVal sender As Object, ByVal e As InsertEmailQCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1087.0"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class InsertEmailQCompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
